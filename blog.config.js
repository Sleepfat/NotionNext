...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'sleep4at', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '做自己想做的事~', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.sleepfat.top', // 网站地址
